...
def default_Mission():
                ...
                img1 = ImageTk.PhotoImage(Image.open("close.png"))
                global b2
...
def toggle_win():
                global f1
                f1=Frame(w,width=200,height=500,bg='#323335')
                f1.place(x=0,y=0)
                ...
                bttn(-50,120,'M I S S I O N','#323335','#323335',mission)
                bttn(-50,160,'T R A J E T','#323335','#323335',trajet)
                bttn(-50,200,'H I S T O R I Q U E','#323335','#323335',historique)
                #
                def dele():
                    f1.destroy()
                ...
                global img2
                img2 = ImageTk.PhotoImage(Image.open("x-circle.png"))
                Button(f1,
                       image=img2,
                       border=0,
                       command=dele,
                       bg='#323335',
                       activebackground='#323335').place(x=5,y=10)
