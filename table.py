...
if __name__ == "__main__":
    ...
    libelle = Label(root, text = 'Mission',font=('Comic Sans MS',23,'bold'),bg='white',fg='#7883F1')
    libelle.pack(padx = 10, pady = 15)

    table = Table(root, ["N°", "Name of mission", "Route","Date","Technology","Test"], column_minwidths=[None, None, None,None,None,None],header_background='#939CF4',header_foreground='black',bordercolor='black',scroll_horizontally=None,scroll_vertically=None)
    table.pack(padx=10,pady=50)

    for i in range(1,5):
            table.insert_row([i,"aya saoudi","rue abou alaa maari tunis","23/02/2022","3G","Voix"])
